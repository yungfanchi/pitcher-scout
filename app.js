...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
    ...
    function injectDemoData() {
        // ── 雙打者完整測試資料 ──
        // A：田中健太 #3 右打（積極揮棒，滑球弱點，兩好球易被三振）
        // B：山田太郎 #7 左打（耐心等球，兩好球仍具威脅，戰術積極）
        const _ts = Date.now();
        const _spd = {快速球:132,卡特球:122,二縫線:126,滑球:118,曲球:112,變速球:108};
        ...
        const pA = [
            // ① 田中健太 — 15打席，首球揮棒率 60%，滑球弱點
            // AB1：首球內角揮棒空振→0-2三振（滑球 z6）
            A(0,0,'4','快速球',1),A(0,1,'6','滑球',1),A(0,2,'6','滑球',1,0,['三振']),
            // AB2：首球外角快速球安打（z3）
            A(0,0,'3','快速球',1,0,['一壘安打'],{x:0.72,y:0.42,zone:'RF'}),
            // AB3：首球內角界外→2-2飛球出局（快速球 z3）
            A(0,0,'1','快速球',1,1),A(0,1,'B5','曲球'),A(1,1,'5','卡特球',1,1),A(1,2,'B9','滑球'),A(2,2,'3','快速球',1,0,['飛球出局'],{x:0.75,y:0.20,zone:'RF'}),
            // AB4：首球不揮棒→0-2三振（滑球 z6，加強②zone6樣本）
            A(0,0,'5','快速球'),A(0,1,'6','滑球',1),A(0,2,'6','滑球',1,0,['三振']),
            // AB5：首球內角界外→1-2二壘安打（快速球 z3）
            A(0,0,'7','快速球',1,1),A(0,1,'B8','曲球'),A(1,1,'3','快速球',1,0,['二壘安打'],{x:0.68,y:0.28,zone:'RCF'}),
            // AB6：2-2打帶跑+一壘安打（z2，有壘上）
            A(0,0,'B1','快速球',0,0,[],null,1),A(1,0,'5','滑球',0,0,[],null,1),
            A(1,1,'B6','快速球',0,0,[],null,1),A(2,1,'9','曲球',1,1,[],null,1),
            A(2,2,'2','快速球',1,0,['一壘安打','打帶跑'],{x:0.55,y:0.65,zone:'2B'},1),
            // AB7：首球內角揮棒→0-2三振（卡特球 z7）
            A(0,0,'4','快速球',1),A(0,1,'7','卡特球',1),A(0,2,'7','卡特球',1,0,['三振']),
            // AB8：首球外角飛球出局（z3 快速球）
            A(0,0,'3','快速球',1,0,['飛球出局'],{x:0.78,y:0.18,zone:'RF'}),
            // AB9：首球不揮棒→1-2三振（滑球 z6，加強②zone6樣本）
            A(0,0,'5','快速球'),A(0,1,'B2','曲球'),A(1,1,'6','滑球',1),A(1,2,'6','滑球',1,0,['三振']),
            // AB10：首球內角揮棒→0-2飛球出局（卡特球 z9）
            A(0,0,'1','快速球',1),A(0,1,'9','卡特球',1),A(0,2,'9','卡特球',1,0,['飛球出局'],{x:0.80,y:0.28,zone:'RF'}),
            // AB11：首球揮棒空振→保送
            A(0,0,'4','快速球',1),A(0,1,'B3','曲球'),A(1,1,'B7','快速球'),A(2,1,'B11','滑球'),A(3,1,'B15','快速球',0,0,['保送']),
            // AB12：首球不揮棒→2-2滾地出局（二縫線 z2）
            A(0,0,'5','快速球'),A(0,1,'B4','曲球'),A(1,1,'5','快速球'),A(1,2,'B6','滑球'),A(2,2,'2','二縫線',1,0,['滾地球出局'],{x:0.50,y:0.75,zone:'P'}),
            // AB13：首球內角揮棒→1-2三振（滑球 z6）
            A(0,0,'4','快速球',1),A(0,1,'B5','曲球'),A(1,1,'5','快速球'),A(1,2,'6','滑球',1,0,['三振']),
            // AB14：首球內角揮棒空振→0-2三振（滑球 z6，連動②z6）
            A(0,0,'7','快速球',1),A(0,1,'6','滑球',1),A(0,2,'6','滑球',1,0,['三振']),
            // AB15：首球不揮棒→2-2一壘安打（快速球 z6）
            A(0,0,'B1','快速球'),A(1,0,'5','快速球'),A(1,1,'B5','曲球'),A(2,1,'9','滑球'),A(2,2,'6','快速球',1,0,['一壘安打'],{x:0.70,y:0.48,zone:'RF'}),
        ];

        const pB = [
            // ② 山田太郎 — 12打席，首球揮棒率 17%，兩好球仍具威脅
            // AB1：首球不揮棒→1-1 三壘安打（快速球 z4，左打外角）
            B(0,0,'5','快速球'),B(0,1,'B2','滑球'),B(1,1,'4','快速球',1,0,['三壘安打'],{x:0.18,y:0.25,zone:'LF'}),
            // AB2：首球不揮棒→1-2三振（曲球 z1）
            B(0,0,'5','快速球'),B(0,1,'B6','快速球'),B(1,1,'1','曲球',1),B(1,2,'1','曲球',1,0,['三振']),
            // AB3：首球揮棒→0-0全壘打（快速球 z6，左打甜區）
            B(0,0,'6','快速球',1,0,['全壘打'],{x:0.75,y:0.12,zone:'RF'}),
            // AB4：首球不揮棒→2-2一壘安打（快速球 z6）
            B(0,0,'5','快速球'),B(0,1,'B3','滑球'),B(1,1,'5','快速球'),B(1,2,'B9','曲球'),B(2,2,'6','快速球',1,0,['一壘安打'],{x:0.72,y:0.55,zone:'RF'}),
            // AB5：首球不揮棒→犧牲觸擊（有壘上）
            B(0,0,'5','快速球',0,0,[],null,1),B(0,1,'8','快速球',1,0,['犧牲觸擊'],{x:0.45,y:0.80,zone:'P'},1),
            // AB6：首球不揮棒→0-2三振（滑球 z9）
            B(0,0,'5','快速球'),B(0,1,'9','滑球',1),B(0,2,'9','滑球',1,0,['三振']),
            // AB7：首球不揮棒→2-2二壘安打（快速球 z4，左打外角甜區）
            B(0,0,'B1','快速球'),B(1,0,'5','滑球'),B(1,1,'B5','曲球'),B(2,1,'4','快速球',1),B(2,2,'4','快速球',1,0,['二壘安打'],{x:0.20,y:0.32,zone:'LCF'}),
            // AB8：首球不揮棒→保送
            B(0,0,'B3','快速球'),B(1,0,'B7','滑球'),B(2,0,'B11','快速球'),B(3,0,'B15','曲球',0,0,['保送']),
            // AB9：首球不揮棒→0-2飛球出局（快速球 z3，左打內角）
            B(0,0,'5','快速球'),B(0,1,'9','滑球',1),B(0,2,'3','快速球',1,0,['飛球出局'],{x:0.28,y:0.18,zone:'LF'}),
            // AB10：首球揮棒→1-2一壘安打（快速球 z4，左打外角）
            B(0,0,'4','快速球',1),B(0,1,'B6','滑球'),B(1,1,'4','快速球'),B(1,2,'4','快速球',1,0,['一壘安打'],{x:0.22,y:0.45,zone:'LF'}),
            // AB11：首球不揮棒→2-2滾地出局（二縫線 z2）
            B(0,0,'5','快速球'),B(0,1,'B4','曲球'),B(1,1,'5','快速球'),B(1,2,'B8','滑球'),B(2,2,'2','二縫線',1,0,['滾地球出局'],{x:0.48,y:0.72,zone:'P'}),
            // AB12：首球不揮棒→2-2二壘安打（快速球 z4）
            B(0,0,'B1','快速球'),B(1,0,'5','滑球'),B(1,1,'B5','曲球'),B(2,1,'6','快速球',1),B(2,2,'4','快速球',1,0,['二壘安打'],{x:0.18,y:0.35,zone:'LCF'}),
        ];

        // ③ 武田一郎 #5 右打（兩好球容易被三振【滑球】— 測試「三振球種標籤」）
        // 設計：10個兩好球終結打席，三振5次（滑球3/快速球1/曲球1），無單一球種≥50%出局
        const pC = [
            // AB1 0-2 三振（滑球 z6）
            C(0,0,'4','快速球'),C(0,1,'6','滑球',1),C(0,2,'6','滑球',1,0,['三振']),
            // AB2 2-2 三振（滑球 z9）
            C(0,0,'B1','快速球'),C(1,0,'5','快速球'),C(1,1,'B5','曲球'),C(2,1,'9','滑球',1),C(2,2,'9','滑球',1,0,['三振']),
            // AB3 1-2 三振（滑球 z6）
            C(0,0,'4','快速球'),C(0,1,'B2','二縫線'),C(1,1,'6','快速球',1,1),C(1,2,'6','滑球',1,0,['三振']),
            // AB4 0-2 三振（快速球 z3）
            C(0,0,'5','快速球'),C(0,1,'8','快速球',1,1),C(0,2,'3','快速球',1,0,['三振']),
            // AB5 1-2 三振（曲球 z7）
            C(0,0,'5','快速球'),C(0,1,'B3','滑球'),C(1,1,'7','曲球',1),C(1,2,'7','曲球',1,0,['三振']),
            // AB6 1-2 滾地球出局（快速球 z2）
            C(0,0,'5','快速球'),C(0,1,'B6','二縫線'),C(1,1,'5','快速球'),C(1,2,'2','快速球',1,0,['滾地球出局'],{x:0.50,y:0.78,zone:'P'}),
            // AB7 1-2 滾地球出局（快速球 z5）
            C(0,0,'4','快速球',1),C(0,1,'B2','曲球'),C(1,1,'5','快速球'),C(1,2,'5','快速球',1,0,['滾地球出局'],{x:0.48,y:0.70,zone:'P'}),
            // AB8 1-2 滾地球出局（二縫線 z2）
            C(0,0,'5','快速球'),C(0,1,'B5','曲球'),C(1,1,'5','快速球'),C(1,2,'2','二縫線',1,0,['滾地球出局'],{x:0.52,y:0.72,zone:'P'}),
            // AB9 1-2 滾地球出局（二縫線 z5）
            C(0,0,'B1','快速球'),C(1,0,'5','快速球'),C(1,1,'5','二縫線'),C(1,2,'5','二縫線',1,0,['滾地球出局'],{x:0.50,y:0.68,zone:'P'}),
            // AB10 0-2 飛球出局（卡特球 z3）
            C(0,0,'4','快速球',1),C(0,1,'9','卡特球',1),C(0,2,'3','卡特球',1,0,['飛球出局'],{x:0.75,y:0.22,zone:'RF'}),
        ];
